...
export {PreferenceCategoryEnum, AuthenticationFieldEnum, ingredientDataFields, GROUP_OF_DISPLAYED_CARDS, TOTAL_SEARCH_REQUESTS, INGREDIENT_MODAL, GROCERY_MODAL}